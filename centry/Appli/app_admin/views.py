...
from Baracuda_Service.forms import ArticleForm
...
def user_articles(request):
    has_perm =False
    if request.user.has_perm("Baracuda_Service.delete_article"):
        has_perm = True
...
class DeleteArticle(DeleteView):
    ...
    def dispatch(self, request, *args, **kwargs): 
        if not request.user.has_perm('Baracuda_Service.delete_article'):
